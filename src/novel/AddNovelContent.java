...
/**
 * Servlet implementation class AddNovelContent
 */
@WebServlet("/AddNovelContent")
public class AddNovelContent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddNovelContent() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        n = dao.addNovelContent(novelIdx, contentName, content);
